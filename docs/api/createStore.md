...
The principal difference between this example and the first one, is that this one does not use a `Provider` to supply the `store` with the rest of the application. It is local to this component.
