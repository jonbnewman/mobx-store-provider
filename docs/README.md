...
**mobx-store-provider** is a library that provides React Hooks for setting up and accessing [mobx-state-tree](http://mobx-state-tree.js.org/) models from within functional React components.
